        ...
        <Grid container spacing={3}>
          <Grid item xs={12}>
              ...
              <Typography align="center">
                ...
                are performing, but points are determined at the end of the
                season by a team's position in their league (see below).
              </Typography>
              <Typography align="center">
                Note leaderboards, portfolio charts, and stock charts are
                updated once daily at 12:00 EST. Point values will be updated
                weekly.
              </Typography>
              <hr />
              <Typography align="center">
              ...
              <Typography align="center">
                1) Every stock has a BIN (buy it now) price that you can
                instantly purchase any number of shares at.
              </Typography>
              <Typography align="center">
              ...
              <Typography align="center">
                For every transaction that occurs, the BIN price and instant
                sell price gets updated slightly based on an algorithm.
              </Typography>
              <Typography align="center">
              ...
              <Typography align="center">
                ...
                value, it uses the price that is halfway between the BIN price
                and the instant sell price.
              </Typography>
              <hr />
              ...
              <Typography align="center">
                Instant Sell Price: Any amount can be sold instantly at this
                price (half the BIN Price)
              </Typography>
              <Typography align="center">
